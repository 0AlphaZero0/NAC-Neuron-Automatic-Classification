...
def separateurfichier():
	...
	sep2 = Radiobutton(load, text = "Point-virgule", variable = separateur, value =';', command=resultatsseparateur)
	sep3 = Radiobutton(load, text = "Tab", variable = separateur, value ='	',command=resultatsseparateur)
...
def resultatsappui():#### Choice of the training file
	...
	if variable2==1:
		nomdufichierentrainement=tkFileDialog.askopenfilename(initialdir = "/net/cremi/cljouan/espaces/travail/RESONEURON/Projet-Neuro/Clément/Interface",title = "Selection du fichier entrainement",filetypes = (("Fichier csv","*.csv"),("Fichier texte","*.txt")))
		separateurfichier()

...
def save(percentage,t,vf,ft):
	file=codecs.open("result75train-25test-lbfgs-regressor-logistic.csv","a",encoding="utf-8")
...
for combin in all_combin:
	...
	while top==0:
		...
		if t==10000:
			...
			break
		while top==0:
			MLPRegressor(activation='relu', alpha=t, batch_size='auto', hidden_layer_sizes=(100,), random_state=None, tol=h, validation_fraction=vf, verbose=False, warm_start=False)

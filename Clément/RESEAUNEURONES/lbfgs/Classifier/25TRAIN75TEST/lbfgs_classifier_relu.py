...
def save(percentage,t,vf,ft):
	file=codecs.open("result25train-75test-lbfgs-reluround.csv","a",encoding="utf-8")
	...
	while vf<1:
		...
		while top==0:
			...
			if t==10000:
				...
				break
			while top==0:
				clf = MLPClassifier(solver='lbfgs', activation='relu', batch_size='auto', alpha=t, hidden_layer_sizes=(100,), random_state=None, tol=h, validation_fraction=vf, verbose=False, warm_start=False)

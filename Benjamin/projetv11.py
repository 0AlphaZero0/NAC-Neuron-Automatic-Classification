...
def separateurfichier(): #### Give the file separator
	...
	def resultatsseparateur():
		...
		if typesfichier==2:
			print "Koooooooooooooooooo"
		
	typesfichiers=typefichier.get()
	global separateur
	global load
	load=Toplevel()
	s1 = Radiobutton(load, text = "Virgule", variable = separateur, value =',',command=resultatsseparateur)
	s2 = Radiobutton(load, text = "Point-virgule", variable = separateur, value =';', command=resultatsseparateur)
	s3 = Radiobutton(load, text = "Tab", variable = separateur, value ='	',command=resultatsseparateur)
	s4 = Radiobutton(load, text = "Deux points", variable = separateur, value =':', command=resultatsseparateur)
	s5 = Radiobutton(load, text = "Espace", variable = separateur, value =' ', command=resultatsseparateur)
	s1.pack();s2.pack();s3.pack();s4.pack();s5.pack()
	load.mainloop()
...
def load(filename,typefichier): #### File loading
	...
	#revoir
	sep=separateur2.get()
	print sep,'helllllloooooo'
	result=file(filename,"r").read().replace(sep, ",")################!!!!!!!!!!!!!!!
...
def choixechantillons():
	...
	Q1= Button(choixechantiloons, text= "Fermer", fg= "Black",bg= "SkyBlue3", command= choixechantillons.destroy, font= helv36, bd= 4, bitmap= "error")

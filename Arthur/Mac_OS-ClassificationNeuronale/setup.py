...
setup(
    ...
    options={"py2exe":{r'includes':[r'scipy.sparse.csgraph._validation',r'scipy.linalg.cython_blas',r'scipy.linalg.cython_lapack', r'scipy.special._ufuncs_cxx',r'scipy._lib.messagestream',r'scipy._lib.messagestream',r'sklearn.utils.lgamma',r'sklearn.utils.weight_vector',r'sklearn.neighbors.typedefs',r'os'],'py2app':OPTIONS}},

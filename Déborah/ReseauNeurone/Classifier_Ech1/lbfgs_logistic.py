...
def save(percentage,t,vf,ft):
	file=codecs.open("result75train-25test-lbfgs-logistic_ech1.csv","a",encoding="utf-8")
	...
	while vf<1:
		...
		while top==0:
			...
			if t==10000:
				...
				break
			while top==0:
				clf = MLPClassifier(solver='lbfgs', activation='logistic',alpha=t, batch_size='auto', hidden_layer_sizes=(100,), random_state=None, tol=h, validation_fraction=vf, verbose=False, warm_start=False)

...
def save(percentage,t,ft):
	file=codecs.open("resultPOLY-NuSVC.csv","a",encoding="utf-8")
...
for combin in all_combin:# choose the good combination 
    ...
    t=0.1
    while t<0.6: # first hyperparam
		h=0
		while h<4:# second hyperparam
			k,g,TMP=5,0,0
			meanperc=[]
			while k>0:# mean stabilisation
				...
				clf=svm.NuSVC(kernel='poly',degree=h,nu=t)### MODEL CREATION
			...
			print MEAN,"% pour un Nu=",t,"et un degree=",h,"ainsi que les parametres : ",
			listftsave=[]

...
def save(percentage,t,ft):
	file=codecs.open("resultLINEAR-NuSVC.csv","a",encoding="utf-8")
...
for combin in all_combin:#combination
    SET=[]
    for sample in DATA:
        u=[]
        u.append(sample[0])
    ...
    while t<0.6:#first hyperparam
        ...
        while k>0:#mean stabilisation
            ...
            clf=svm.NuSVC(kernel='linear',nu=t)### MODEL CREATION
        ...
        print MEAN,"% pour un Nu=",t,"ainsi que les parametres : ",
        listftsave=[]
        for j in combin:

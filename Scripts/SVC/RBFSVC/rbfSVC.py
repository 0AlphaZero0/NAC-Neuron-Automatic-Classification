...
#
def save(percentage,t,h,ft):
	file=codecs.open("resultRBF-SVC.csv","a",encoding="utf-8")
...
for combin in all_combin:# choose the good combination 
    ...
    t=0.00001
    while t<100000000: # first hyperparam
		h=1*10**-12
		while h<1000:# second hyperparam
			...
			while k>0:# mean stabilisation
				...
				clf=svm.SVC(kernel='rbf',gamma=h,C=t)### MODEL CREATION
			...
			print MEAN,"% pour un C=",t,"et un gamma=",h,"ainsi que les parametres : ",
			listftsave=[]
